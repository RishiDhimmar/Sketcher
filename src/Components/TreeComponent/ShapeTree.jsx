      ...
      <div className="file">
        <div className="tree-element flex justify-between hover:bg-white py-2 rounded">
          <div className="file wrap1 flex ">
            <div className="icon-con arrow my-1 mr-2 cursor-pointer">
              <IoMdArrowDropright />
            </div>
            <div className="font-roboto normal-roboto">My File 1</div>
          </div>
          <div className="wrap2 flex gap-3">
            <div className="icon-con eye-icon text-lg my-1 cursor-pointer">
              <LuEye />
            </div>
            <div className="icon-con bin-icon my-1 cursor-pointer">
              <IoTrashOutline />
            </div>
          </div>
        </div>
